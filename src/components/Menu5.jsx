...
import Bahan2 from "../assets/img/bahan2/bolognese.jpg";
...
const Menu5 = () => {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center overflow-y-auto relative bg-maindish3 bg-cover bg-center min-h-screen">
            <h1
                ...
                {showCircleButton && !isPopupOpen && (
                    <div className="absolute right-[250px]">
                        <button
                            ...
                            onClick={() =>
                                openPopup(
                                    "Pasta berbahan baku tepung sebagai pengganti karbohidrat, dan telur sebagai protein dalam hidangan",
                                    Bahan1,
                        ...
                        <button
                            className="btnbase top-[250px] left-[250px]"
                            onClick={() =>
                                openPopup(
                                    "Memiliki cita rasa gurih dengan kandungan daging sapi, bawang putih, bawang bombay, tomat, dan garnish parsley. Untuk tomat dan daging sapi, kami bekerjasama dengan para kelompok tani Buruan Sae Kota Bandung.",
                                    Bahan2,
                                    "BOLOGNESE SAUCE" // Menetapkan judul pop-up
                                )
                            }
                        >
                            <span className="btnanimate"></span>
            ...
            <div className="foodfact">
                ...
                <h3 className="text-2xl font-keterangan text-justify mb-4">
                    Ragù alla Bolognese, yang disebut sebagai saus Bolognese, adalah saus berbahan dasar daging yang berasal
                    dari kota Bologna di Italia utara. Saus Bolognese disajikan sebagai topping untuk tagliatelle, pasta pipih seperti pita,
                    yang dinikmati banyak orang di wilayah Emilia-Romagna,
                    Italia.
                </h3>
            </div>
