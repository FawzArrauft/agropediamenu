...
const Menu3 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-maindish1 bg-cover bg-center min-h-screen overflow-y-auto">
      <h1
      ...
      <div className="mt-10 relative">
        ...
        {showCircleButton && !isPopupOpen && (
          <div className="absolute right-[250px]">
            <button
              className="btnbase top-[350px] left-[150px]"
              onClick={() =>
                openPopup(
                  "Daging segar yang diolah menggunakan saus teriyaki, untuk menambah rasa yang unik.",
                  Bahan1,
                  "BEEF TERIYAKI" // Menetapkan judul pop-up
                )
              }
            >
            ...
            <button
              className="btnbase top-[350px] left-[550px]"
              onClick={() =>
                openPopup(
      ...
      <div className="text-center mb-10">
        <h1 className="textfoodname">
          MR. B FOR BEEF WITH TERIYAKI
        </h1>
        <h2 className="mt-3 font-foodname textbg text-5xl">
          Enjoy the tender meat wrapped in teriyaki sauce.
        </h2>
      </div>
