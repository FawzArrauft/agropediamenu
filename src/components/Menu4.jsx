...
import Bahan1 from "../assets/img/bahan2/beefteriyaki.jpg";
...
const Menu4 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-maindish2 bg-cover bg-center min-h-screen overflow-y-auto">
      <h1
      ...
      <div className="mt-10 relative">
        ...
        {showCircleButton && !isPopupOpen && (
          <div className="absolute right-[250px]">
            <button
              className="btnbase top-[570px] left-[350px]"
              onClick={() =>
                openPopup(
                  "Daging segar yang diolah menggunakan saus bolognese, untuk menambah rasa yang unik.",
                  Bahan1,
                  "BEEF BOLOGNESE" // Menetapkan judul pop-up
                )
              }
            >
            ...
            <button
              className="btnbase top-[500px] left-[190px]"
              onClick={() =>
                openPopup(
            ...
            <button
              className="btnbase top-[290px] left-[100px]"
              onClick={() =>
                openPopup(
      ...
      <div className="text-center mb-10">
        <h1 className="textfoodname">
          MR. B FOR BEEF WITH BOLOGNESE
        </h1>
        <h2 className="mt-3 font-foodname  font-bold textbg text-5xl">
          Enjoy the tender meat wrapped in Bolognese sauce.
        </h2>
      </div>
      <div className="foodfact">
        ...
        <div className="text-2xl font-keterangan text-justify mb-4 break-normal">
          Burger adalah makanan cepat saji yang terdiri dari roti dan patty daging. Asal-usul burger berasal dari kota Hamburg di negara Jerman. Dalam bahasa Inggris, hamburger berarti “makanan yang berasal dari Hamburg
        </div>
      </div>
